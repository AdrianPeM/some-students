        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden">
                <div class="flex flex-col px-12 bg-white">
                    <form method="POST" id="social-service-form" action="{{ route('servicio_social') }}" class="border border-gray-lightest rounded-lg">
                        @csrf
                        <div class="px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-2 gap-6">
                                ...
                                <div class="col-span-1">
                                    ...
                                    <input type="number" name="accum_hours" id="accum_hours" value="{{ old('accum_hours') }}" class="mt-1 focus:ring-indigo focus:border-indigo block w-full shadow-sm sm:border-gray-light rounded-md">
                                    @error('accum_hours')
                                        <p class="text-red">{{$message}}</p>
                                    @enderror
                                </div>
